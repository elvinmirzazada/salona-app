  ...
  return (
    <>
      ...
      <button
        ...
        aria-label={isMobileOpen ? t('common.close') : t('common.open')}
      >
        {!isMobileOpen ? (
          // Hamburger Menu Icon
          <svg
            ...
            {showCompanyBranding ? (
              <>
                ...
                <div className="sidebar-company-info">
                  ...
                  <span className="sidebar-company-subtitle">{t('sidebar.managementSystem')}</span>
                </div>
              </>
            ) : (
              <>
            ...
            {(!user?.role || !user?.company_id) && (
              <li>
                ...
                >
                  ...
                  <span className="sidebar-nav-text" style={{ fontWeight: 600 }}>{t('sidebar.createCompany')}</span>
                </Link>
              </li>
            )}
              ...
              <>
                ...
                {isAdmin && (
                  <li>
                    ...
                    >
                      ...
                      <span className="sidebar-nav-text">{t('sidebar.dashboard')}</span>
                    </Link>
                  </li>
                )}
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="sidebar-nav-text">{t('sidebar.calendar')}</span>
                  </Link>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="sidebar-nav-text">{t('sidebar.staff')}</span>
                  </Link>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="sidebar-nav-text">{t('sidebar.customers')}</span>
                  </Link>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="sidebar-nav-text-flex">{t('sidebar.services')}</span>
                    <svg
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="sidebar-nav-text">{t('sidebar.membership')}</span>
                  </Link>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="sidebar-nav-text-flex">{t('sidebar.integrations')}</span>
                    <svg
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="sidebar-nav-text">{t('sidebar.notifications')}</span>
              ...
              >
                <svg className="sidebar-nav-icon" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M18 7.5h-.423l-.452-1.09.3-.3a1.5 1.5 0 0 0 0-2.121L16.01 2.575a1.5 1.5 0 0 0-2.121 0l-.3.3-1.089-.452V2A1.5 1.5 0 0 0 11 .5H9A1.5 1.5 0 0 0 7.5 2v.423l-1.09.452-.3-.3a1.5 1.5 0 0 0-2.121 0L2.576 3.99a1.5 1.5 0 0 0 0 2.121l.3.3L2.423 7.5H2A1.5 1.5 0 0 0 .5 9v2A1.5 1.5 0 0 0 2 12.5h.423l.452 1.09-.3.3a1.5 1.5 0 0 0 0 2.121l1.415 1.413a1.5 1.5 0 0 0 2.121 0l.3-.3 1.09.452V18A1.5 1.5 0 0 0 9 19.5h2a1.5 1.5 0 0 0 1.5-1.5v-.423l1.09-.452.3.3a1.5 1.5 0 0 0 2.121 0l1.415-1.414a1.5 1.5 0 0 0 0-2.121l-.3-.3.452-1.09H18a1.5 1.5 0 0 0 1.5-1.5V9A1.5 1.5 0 0 0 18 7.5Zm-8 6a3.5 3.5 0 1 1 0-7 3.5 3.5 0 0 1 0 7Z" />
                    ...
                    <span className="sidebar-nav-text-flex">{t('sidebar.settings')}</span>
                    <svg
                ...
                {isActive && isActivePath('/dashboard') && (
                  <li>
                    <button onClick={toggleFullscreen} className="sidebar-nav-link">
                      ...
                      <span className="sidebar-nav-text">{t('sidebar.fullscreen')}</span>
                    </button>
                  </li>
                )}
                ...
                <li>
                  <button onClick={handleLogout} className="sidebar-nav-link sidebar-nav-link-danger">
                    ...
                    <span className="sidebar-nav-text">{t('sidebar.logout')}</span>
              </button>
            </li>
          </ul>
        </div>
